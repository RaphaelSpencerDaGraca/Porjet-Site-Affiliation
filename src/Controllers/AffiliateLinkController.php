...
class AffiliateLinkController {
    ...
    /**
     * Affiche le formulaire de création d'un lien d'affiliation
     */
    public function create() {
        $this->checkAuth();

        // Récupérer les marques actives pour le formulaire
    ...
    public function store() {
        ...
        if (!empty($errors)) {
            ...
            header('Location: index.php?controller=affiliateLink&action=create');
            exit;
        }
    ...
    public function adminIndex() {
        ...
        include 'views/admin/affiliate_links/index.php';
    }
